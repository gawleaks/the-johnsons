    ...
    expect(created).toEqual([
      {
        ...
        thinking: defaultPolicy.roles.architect.thinking,
        tools: defaultPolicy.roles.architect.tools,
      ...
      },
      {
        ...
        thinking: defaultPolicy.roles.reviewer.thinking,
        tools: defaultPolicy.roles.reviewer.tools,
